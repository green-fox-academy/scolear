...
BlogPost::BlogPost(const std::string &authorName, const std::string &title, const std::string &publicationDate)
        : _authorName(authorName), _title(title), _publicationDate(publicationDate) {}
